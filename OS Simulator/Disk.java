...
public class Disk extends Thread {
	...
	if ( blockId < 0 || blockId > diskSize ) {
	    SysLib.cerr( "threadOS: a wrong blockId for read - BlockID: " + blockId + " DiskSize: " + diskSize + "\n" );
	    return false;
	}
	...
	if ( blockId < 0 || blockId > diskSize ) {
	    SysLib.cerr( "threadOS: a wrong blockId for write - BlockID: " + blockId + " DiskSize: " + diskSize + "\n" );
	    return false;
	}
